        ...
        <div className="min-h-screen bg-[#14161a]">
            ...
            >
                <div className='relative z-10 text-center pt-12'>
                    ...
                    <p className='text-sm font-medium text-gray-300'>Get all the Info regarding your favorite Crypto Currency</p>
                </div>
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    {currentCoins.map((coin) => (
                        <div key={coin.id} className="card flex items-center justify-between p-4 bg-transparent rounded-lg shadow-lg text-white">
                            ...
                            <div className={`w-1/4 flex justify-center items-center text-lg font-semibold ${coin.price_change_percentage_24h > 0 ? 'text-green-400' : 'text-red-400'}`}>
                ...
                <div className="flex justify-center mt-8">
                    {[...Array(Math.ceil(filteredCoins.length / coinsPerPage))].map((_, index) => (
                        <button
                            ...
                            className={`px-4 py-2 mx-1 rounded-md ${currentPage === index + 1 ? 'bg-indigo-600 text-white' : 'bg-gray-600 text-white'}`}
                        >
                            {index + 1}
                        </button>
                    ))}
